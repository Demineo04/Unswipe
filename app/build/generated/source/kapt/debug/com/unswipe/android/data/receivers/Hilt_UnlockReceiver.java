...
public abstract class Hilt_UnlockReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((UnlockReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectUnlockReceiver(UnsafeCasts.<UnlockReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
