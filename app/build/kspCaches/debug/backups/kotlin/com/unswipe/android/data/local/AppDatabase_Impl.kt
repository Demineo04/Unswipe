...
public class AppDatabase_Impl : AppDatabase() {
  ...
  protected override fun createOpenDelegate(): RoomOpenDelegate {
    val _openDelegate: RoomOpenDelegate = object : RoomOpenDelegate(1,
        "5fefd91fb8a4e1a5542658dd15d9404f", "86e8fc355954e663c8afc2a18b535e7b") {
      public override fun createAllTables(connection: SQLiteConnection) {
        connection.execSQL("CREATE TABLE IF NOT EXISTS `usage_events` (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `timestamp` INTEGER NOT NULL, `packageName` TEXT NOT NULL, `eventType` TEXT NOT NULL, `additionalData` TEXT)")
        ...
        connection.execSQL("INSERT OR REPLACE INTO room_master_table (id,identity_hash) VALUES(42, '5fefd91fb8a4e1a5542658dd15d9404f')")
      }
      ...
      public override fun onValidateSchema(connection: SQLiteConnection):
        ...
        _columnsUsageEvents.put("eventType", TableInfo.Column("eventType", "TEXT", true, 0, null,
            TableInfo.CREATED_FROM_ENTITY))
        _columnsUsageEvents.put("additionalData", TableInfo.Column("additionalData", "TEXT", false,
