...
import com.unswipe.android.ui.insights.InsightsScreen
import com.unswipe.android.ui.components.MainScaffold
import com.unswipe.android.ui.goals.GoalsPlaceholderScreen
...
fun UnswipeNavGraph(
    ...
    // Wrap the entire navigation in MainScaffold to show bottom navigation
    MainScaffold(navController = navController) { paddingValues ->
        ...
        NavHost(navController = navController, startDestination = startDestination) {
            ...
            // Define the Insights screen destination
            ...
            // Define the Premium/Goals screen placeholder
            composable(Screen.Premium.route) {
                // Placeholder for Goals screen - showing a simple UI for now
